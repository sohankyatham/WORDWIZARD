...
def main():
    ...
    while run:
        ...
        if won:
            messagebox.showinfo("YOU WON!", "You won the game! Return to the main menu.", command=print("Hello"))
            break
        if hangman_status == 9:
            messagebox.showinfo("You lost.", "You did not guess the word right. Return to the main menu.",
                                command=print("hello"))
            break
